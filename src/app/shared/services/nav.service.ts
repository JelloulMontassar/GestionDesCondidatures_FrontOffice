...
export class NavService implements OnDestroy {
  ...
  constructor(private profileService: ProfileService, private entrepriseService: EntrepriseService, private router: Router, private storageService: StorageService, private sessionService: SessionService) {
    ...
    this.sessionSubscription = this.sessionService.sessionChanges$.pipe(
      debounceTime(200)
    ).subscribe(() => {
  ...
  updateMenuItems() {
    this.entrepriseService.getEntreprise(this.storageService.getUtilisateur().idEntrepriseEnCours).subscribe((dataEntreprises: any) => {
      this.ModuleInstaller = dataEntreprises.listModuleInstalleParEntreprise.filter(module => module.active === true);
      if (this.storageService.getUtilisateur().idEntrepriseEnCours === this.storageService.getUtilisateur().entreprise.id) {
        this.PrivilegeItem = this.storageService.getUtilisateur().profile.listPrivileges.filter(module => module.active === true);
              ...
              if (elementDetail.active) {
                ...
                if (privilege !== undefined) {
                  if (privilege.lecture && privilege.active) {
                    ...
                    this.MENUITEMS.push(nouvelObjet);
                  }
                }
              }
            })
              ...
              if (elementDetail.active) {
                ...
                if (privilege !== undefined) {
                  if (privilege.lecture) {
                    ...
                    childrenArray.push(nouvelObjet1);
                  }
                }
              }
            })
            const filteredPrivileges = this.PrivilegeItem.filter(
              (item) => item.module === element.libelle && element.active && item.lecture
            );
            if (filteredPrivileges.length >= 1) {
        ...
        this.MENUITEMS.splice(0);
        this.profileService.getSuperProfile(this.storageService.getUtilisateur().idEntrepriseEnCours).subscribe((dataProfile: any) => {
  ...
  MENUITEMS: Menu[] = [
    ...
    /*   {
        ...
        active: false,
        children: [
          { path: "/TempReel", title: "VueGlobale", type: "link" },
        ],
      },
  
      {
        ...
        active: false,
        children: [
          { path: "/Historique", title: "Historique", type: "link" },
        ],
      },
  
      {
        ...
        active: false,
        children: [
          { path: "/Alertes", title: "Alertes", type: "link" },
          { path: "/AlertesSMS", title: "Alertes par SMS", type: "link" },
          { path: "/AlertesEmail", title: "Alertes par Email", type: "link" },
        ],
      },
      {
        title: "Rapports",
        ...
        active: false,
        children: [
          { path: "/Journalier", title: "Journalier", type: "link" },
          { path: "/Hebdomadaire", title: "Hebdomadaire", type: "link" },
          { path: "/Mansuel", title: "Mansuel", type: "link" },
        ],
      },
      {
        title: "Centres&Batiments",
        icon: "centres",
        type: "sub",
        active: false,
        children: [
          { path: "/Centre", title: "Centre", type: "link" },
          { path: "/Silos", title: "Silos", type: "link" },
          { path: "/Batiment", title: "Batiment", type: "link" },
          { path: "/Responsable", title: "Responsable", type: "link" },
          { path: "/Emplacement", title: "Emplacement", type: "link" },
          { path: "/Mouvement", title: "Mouvement", type: "link" },
          { path: "/AffectationSilos", title: "AffectationSilos", type: "link" },
      ...
      {
        title: "GestionDesEquipements",
        icon: "equipement",
        type: "sub",
        active: false,
        children: [
          { path: "/Equipement", title: "Equipement", type: "link" },
          { path: "/Modele", title: "Modele", type: "link" },
          { path: "/Marque", title: "Marque", type: "link" },
          { path: "/Operateur", title: "Operateur", type: "link" },
          { path: "/Puce", title: "Puce", type: "link" },
          { path: "/Affectation", title: "Affectation", type: "link" },
      ...
      },
      {
        ...
        active: false,
        children: [
          { path: "/Utilisateur", title: "Utilisateur", type: "link" },
          { path: "/Profile", title: "Profile", type: "link" },
          { path: "/Privilege", title: "Privilege", type: "link" },
          { path: "/Poste", title: "Poste", type: "link" },
          { path: "/Departement", title: "Service", type: "link" },
          { path: "/Entreprise", title: "Entreprise", type: "link" },
          { path: "/Domaine", title: "Domaine", type: "link" },
          // { path: "/Module", title: "ModuleInstallerParEntreprise", type: "link" },
        ],
      }, */
    /*
     {
